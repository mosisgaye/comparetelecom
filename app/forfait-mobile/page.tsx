...
import { useMobilePageData } from '@/app/hooks/useMobilePageData';
import { MobileHeroSection } from '@/app/components/forfait-mobile/MobileHeroSection';
import { MobileOffersGrid } from '@/app/components/forfait-mobile/MobileOffersGrid';
...
export default function ForfaitMobilePage() {
  const {
    // États
    loading,
    error,
